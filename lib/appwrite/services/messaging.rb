...
module Appwrite
    class Messaging < Service
        ...
        # @param [MessageType] status Message Status. Value must be one of: draft, scheduled, processing.
        ...
        # @param [MessageType] status Message Status. Value must be either draft, cancelled, or processing.
        # @param [String] scheduled_at Scheduled delivery time for message in [ISO 8601](https://www.iso.org/iso-8601-date-and-time-format.html) format. DateTime value must be in future.
        #
        # @return [Message]
        ...
        # @param [Array] targets List of Targets IDs.
        # @param [String] content Email Content.
        # @param [MessageType] status Message Status. Value must be either draft or cancelled or processing.
        # @param [String] scheduled_at Scheduled delivery time for message in [ISO 8601](https://www.iso.org/iso-8601-date-and-time-format.html) format. DateTime value must be in future.
        #
        # @return [Message]
        ...
        #
        # @return [Provider]
        def update_smtp_provider(provider_id:, name: nil, host: nil, port: nil, username: nil, password: nil, encryption: nil, auto_tls: nil, from_name: nil, from_email: nil, reply_to_name: nil, reply_to_email: nil, enabled: nil)
        ...
        # @param [String] name Provider name.
        # @param [String] from Sender Phone number. Format this number with a leading '+' and a country code, e.g., +16175551212.
        # @param [String] username Telesign username.
        # @param [String] password Telesign password.
        # @param [] enabled Set as enabled.
        #
        # @return [Provider]
        def create_telesign_provider(provider_id:, name:, from: nil, username: nil, password: nil, enabled: nil)
        ...
        #
        # @return [Provider]
        def update_telesign_provider(provider_id:, name: nil, enabled: nil, username: nil, password: nil, from: nil)
        ...
        # 
        #
        # @param [Array] queries Array of query strings generated using the Query class provided by the SDK. [Learn more about queries](https://appwrite.io/docs/queries). Maximum of 100 queries are allowed, each 4096 characters long. You may filter on the following attributes: name, description, total
        # @param [String] search Search term to filter your list results. Max length: 256 chars.
        #
        # @return [TopicList]
        ...
        #
        # @return [Topic]
        def create_topic(topic_id:, name:)
            api_path = '/messaging/topics'
