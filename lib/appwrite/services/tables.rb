...
module Appwrite
    class Tables < Service
        ...
        #
        # @return [TableList]
        def list(database_id:, queries: nil, search: nil)
        ...
        #
        # @return [Table]
        def create(database_id:, table_id:, name:, permissions: nil, row_security: nil, enabled: nil)
            api_path = '/databases/{databaseId}/tables'
                .gsub('{databaseId}', database_id)
        ...
        #
        # @return [Table]
        def update(database_id:, table_id:, name:, permissions: nil, row_security: nil, enabled: nil)
            api_path = '/databases/{databaseId}/tables/{tableId}'
                .gsub('{databaseId}', database_id)
                .gsub('{tableId}', table_id)
        ...
        #
        # @return []
        def delete(database_id:, table_id:)
            api_path = '/databases/{databaseId}/tables/{tableId}'
                .gsub('{databaseId}', database_id)
                .gsub('{tableId}', table_id)
        ...
        #
        # @return [RowList]
        def upsert_rows(database_id:, table_id:)
            api_path = '/databases/{databaseId}/tables/{tableId}/rows'
                .gsub('{databaseId}', database_id)
                .gsub('{tableId}', table_id)
        ...
        #
        # @return [Row]
        def upsert_row(database_id:, table_id:, row_id:)
            api_path = '/databases/{databaseId}/tables/{tableId}/rows/{rowId}'
                .gsub('{databaseId}', database_id)
                .gsub('{tableId}', table_id)
                .gsub('{rowId}', row_id)
